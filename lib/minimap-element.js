...
class MinimapElement extends HTMLElement {
  ...
  createdCallback() {
    ...
    this.subscriptions.add(
      atom.config.observe(
        "minimap-next.displayMinimapOnLeft",
      ...
      atom.config.observe(
        "minimap-next.displayPluginsControls",
      ...
      atom.config.observe(
        "minimap-next.displayCodeHighlights",
      ...
      atom.config.observe(
        "minimap-next.adjustMinimapWidthToSoftWrap",
        (adjustToSoftWrap) => {
      ...
      atom.config.observe(
        "minimap-next.useHardwareAcceleration",
