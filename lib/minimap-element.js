...
class MinimapElement extends HTMLElement {
  ...
  createdCallback() {
    ...
    this.subscriptions.add(
      atom.config.observe("minimap-next.displayMinimapOnLeft", (displayMinimapOnLeft) => {
      ...
      atom.config.observe("minimap-next.displayPluginsControls", (displayPluginsControls) => {
      ...
      atom.config.observe("minimap-next.textOpacity", (textOpacity) => {
      ...
      atom.config.observe("minimap-next.displayCodeHighlights", (displayCodeHighlights) => {
      ...
      atom.config.observe("minimap-next.adjustMinimapWidthToSoftWrap", (adjustToSoftWrap) => {
      ...
      atom.config.observe("minimap-next.useHardwareAcceleration", (useHardwareAcceleration) => {
  ...
  connectedCallback() {
    ...
    this.updateMinimapFlexPosition()
    this.attached = true
    this.attachedToTextEditor = this.closest("atom-text-editor") === this.minimap.getTextEditorElement()
