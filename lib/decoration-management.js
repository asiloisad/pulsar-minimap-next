...
export default class DecorationManagement {
  ...
  removeAllDecorations() {
    ...
    const decorationUpdatedSubscriptionsValues =
      this.decorationUpdatedSubscriptions.values();
    for (const decoration of decorationUpdatedSubscriptionsValues) {
      decoration.dispose();
    }

    const decorationDestroyedSubscriptionsValues =
      this.decorationDestroyedSubscriptions.values();
