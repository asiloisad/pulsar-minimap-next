...
class MinimapQuickSettingsElement extends HTMLElement {
  ...
  createdCallback() {
    ...
    this.absoluteMode = document.createElement("li")
    this.absoluteMode.className = "absolute-mode"
    this.absoluteMode.textContent = "absolute-mode"
    this.list.appendChild(this.absoluteMode)

    this.adjustAbsoluteModeHeight = document.createElement("li")
    this.adjustAbsoluteModeHeight.className = "adjust-absolute-mode-height"
    this.adjustAbsoluteModeHeight.textContent = "adjust-absolute-mode-height"
    this.list.appendChild(this.adjustAbsoluteModeHeight)
  ...
  setModel(minimap) {
    ...
    this.subscriptions.add(
      ...
      subscribeTo(this.adjustAbsoluteModeHeight, {
        mousedown: (e) => {
          e.preventDefault()
          atom.config.set("minimap.adjustAbsoluteModeHeight", !atom.config.get("minimap.adjustAbsoluteModeHeight"))
        },
